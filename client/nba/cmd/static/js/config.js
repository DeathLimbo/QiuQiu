...
let config = new Vue({
    ...
    mounted() {
        let files = [
            new FileAgent("D://workspath//nba//robot//nba//cmd//conf//server.json", "Server"),
            new FileAgent("D://workspath//nba//robot//nba//cmd//conf//state.json", "State"),
            new FileAgent("D://workspath//nba//robot//nba//cmd//conf//app.json", "App"),
            new FileAgent("D://workspath//nba//robot//nba//cmd//conf//req_short_cut.json", "Req"),
            new FileAgent("D://workspath//nba//robot//nba//cmd//conf//robot.b3", "Btree"),
        ]
        ...
        console.log("start load all ",files)
        Promise.all(files).then(fas => {
            console.log("file:",fas)
            for (const fa of fas) {
